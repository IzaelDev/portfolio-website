...
const Nav = () => {
  ...
  return (
    <nav
      className={`fixed flex h-[100svh] w-[100svw] justify-center ${menuDisplay ? "bg-[#0F172A] bg-opacity-50 pointer-events-auto" : "pointer-events-none"} z-[300]`}
    >
